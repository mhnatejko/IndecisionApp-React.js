    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidMount() {
            ...
            try {
                ...
                if (options) {
                    //w razie gdy puste i zwroci null
                    this.setState(function () {
                        return { options: options };
                    }); //rownoznaczne z {options:options}
                }
            } catch (error) {
                //do nothing at all
            }
...
var AddOption = function (_React$Component2) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            //inne metody sa przeniesiona z wnetrza komponentu do konstruktora ale to akurat lpeiej jest tu zostawic
            e.preventDefault();
